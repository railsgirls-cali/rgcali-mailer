...
Person.find_or_create_by name: 'Maya Grijalba', email: 'caliope072@gmail.com', gender: 'f', role: 'admin'
...
# Person.find_or_create_by name: 'Juan test', email: 'jroadev@gmail.com', gender: 'f', role: 'attendant'
